	...
	for sub in range (1,8):
			for ch in range (1,63): 
					...
					if (entropy_name == "s"):
						...
						# print("shannon")
						file_name = 'shannons'+str(sub)+'c'+str(ch)+'.txt'
						...
						print("tsallis")
						file_name = 'tsalliss'+str(sub)+'c'+str(ch)+'.txt'
						file = open (file_name,'a+')
						M = len(te_ent)
						for i in range (0,M):
						...
						print("renyi")
						file_name = 'renyis'+str(sub)+'c'+str(ch)+'.txt'
						file = open (file_name,'a+')
						M = len (ren_ent)
						for i in range (0,M):
						...
						print("permutation")		
						M = len (per_ent)
						file_name = 'permuts'+str(sub)+'c'+str(ch)+'.txt'
						file = open (file_name,'a+')
						for i in range (0,M):
